...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                      <!--  <li class="sidebar-search">
                        ...
                        <li>
                            <a href="indexe.php"><i class="fa fa-dashboard fa-fw"></i>Pannello di Controllo</a>
                        </li>
                        <li>
		...
		<?php
include ('5forms/enteconsultaprogetto.php');
include ('5forms/anagraficaVolontario.php');
?>
<!-- contenuto della pagina indexr (che sarebbe l' index per la regione che si logga: quando uno della regione si logga accede qui )-->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-primary">Pannello di controllo Ente</h1> echo{"$id_Ente"};
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row 
