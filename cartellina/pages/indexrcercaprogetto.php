...
<div class="col-md-12">	
  ...
  <thead style="background:#428bca;">
    <tr>
	  ...
	  <th  style="color : white;">Anno Bando</th>
      <th  style="color : white;">Settore Prevalente</th>
      <th  style="color : white;">Altro settore</th>
      <th  style="color : white;">Sede di Attuazione</th>
      <th  style="color : white;">Numero Volontari</th>
  ...
  if(isset($_POST['search'])){
    ...
    <tr>
			...
			<td><strong><?php  echo $row['ente']; ?></strong></td>
			<td><strong><?php  echo $row['titolo']; ?></strong></td>
			<td><strong><?php  echo $row['anno']; ?></strong></td>
			<td><strong><?php  echo $row['prevalente']; ?></strong></td>
			<td><strong><?php  echo $row['altro']; ?></strong></td>
			<td><strong><?php  echo $row['sede']; ?></strong></td>
			<td><strong><?php  echo $row['nv']; ?></strong></td>
