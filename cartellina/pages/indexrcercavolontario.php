...
<div class="col-md-12">	
  ...
  <thead style="background:#428bca;">
    <tr>
      ...
      <th  style="color : white;">Cod. Fis.</th>
      <th  style="color : white;">Sesso</th>
      <th  style="color : white;">Prov/Naz Nasc.</th>
      <th  style="color : white;">Estero</th>
      <th  style="color : white;">Com/Naz Nasc.</th>
      <th  style="color : white;">Indir. Resid.</th>
      <th  style="color : white;">Num. Civ.</th>
      <th  style="color : white;">Cap Resid.</th>
      <th  style="color : white;">Prov. Domic.</th>
      <th  style="color : white;">Com. Domic.</th>
      <th  style="color : white;">Indir. Domic.</th>
      <th  style="color : white;">Num. Civ. Domic.</th>
      <th  style="color : white;">Cap Domic.</th>
      <th  style="color : white;">Tit. Studio</th>
      <th  style="color : white;">Stato</th>
      <th  style="color : white;">NomeOLP</th>
      <th  style="color : white;">CognomeOLP</th>
      <th  style="color : white;">COD. IBAN</th>
  ...
  if(isset($_POST['search'])){
    ...
    <tr>
			...
			<td><strong><?php  echo $row['cognome']; ?></strong></td>
			<td><strong><?php  echo $row['codfis']; ?></strong></td>
			<td><strong><?php  echo $row['sesso']; ?></strong></td>
			<td><strong><?php  echo $row['provnaznas']; ?></strong></td>
			<td><strong><?php  echo $row['estero']; ?></strong></td>
			<td><strong><?php  echo $row['comnaznas']; ?></strong></td>
			<td><strong><?php  echo $row['indres']; ?></strong></td>
			<td><strong><?php  echo $row['nc']; ?></strong></td>
			<td><strong><?php  echo $row['cap']; ?></strong></td>
			<td><strong><?php  echo $row['provdom']; ?></strong></td>
			<td><strong><?php  echo $row['comdom']; ?></strong></td>
			<td><strong><?php  echo $row['inddom']; ?></strong></td>
			<td><strong><?php  echo $row['ncdom']; ?></strong></td>
			
			<td><strong><?php  echo $row['capdom']; ?></strong></td>
			<td><strong><?php  echo $row['titstudio']; ?></strong></td>
			<td><strong><?php  echo $row['stato']; ?></strong></td>
			<td><strong><?php  echo $row['nomeolp']; ?></strong></td>
			<td><strong><?php  echo $row['cognomeolp']; ?></strong></td>
			<td><strong><?php  echo $row['codiban']; ?></strong></td>
