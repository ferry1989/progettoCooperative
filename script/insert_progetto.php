	...
	if(!empty($_SESSION['username'])){
		...
		if($con != null){
			...
			if ($result->num_rows > 0) {
				...
				$insertprogetto = "INSERT INTO progetto (titolo,id_ente,annobando,settoreprevalente,altrosettore,24sett,28sett,36sett,numerovolontari,numgiornidiservizio,nhorestettiman) VALUES ('$titolo','$id_ente','$annobando','$settoreprevalente','$altrosettore','$sett24','$sett28','$sett36','0','0','0')";
